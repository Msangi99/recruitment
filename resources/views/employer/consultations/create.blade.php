...
@section('title', 'Request Consultation - Employer')
...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="lg:ml-64 pt-16 lg:pt-6">
        ...
        <div class="px-4 py-6 sm:px-0">
            <div class="mb-6">
                <a href="{{ route('employer.consultations.index') }}" class="text-indigo-600 hover:text-indigo-900">← Back to Consultations</a>
                <h2 class="mt-4 text-2xl font-bold text-gray-900">Request Free Consultation</h2>
                <p class="mt-1 text-sm text-gray-500">Schedule a free consultation with our recruitment team</p>
            </div>

            <form method="POST" action="{{ route('employer.consultations.store') }}" class="bg-white shadow-lg rounded-lg p-8">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-md p-4">
                        <p class="text-sm text-green-800">
                            <strong>Free Consultation:</strong> This consultation is completely free for employers. Your request will be reviewed and confirmed by our team.
                        </p>
                    </div>

                    <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                        <a href="{{ route('employer.consultations.index') }}" 
