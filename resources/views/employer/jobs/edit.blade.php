                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select id="working_mode" name="working_mode"
                                        ...
                                        <option value="on-site" {{ old('working_mode', $job->working_mode ?? '') == 'on-site' ? 'selected' : '' }}>On-site</option>
                                        <option value="remote" {{ old('working_mode', $job->working_mode ?? '') == 'remote' ? 'selected' : '' }}>Remote</option>
                                        <option value="hybrid" {{ old('working_mode', $job->working_mode ?? '') == 'hybrid' ? 'selected' : '' }}>Hybrid</option>
                                    </select>
                                </div>
                                <div>
                                    <label for="industry"
                                    ...
                                    <select id="industry" name="industry"
                                        ...
                                        <option value="Construction" {{ old('industry', $job->industry ?? '') == 'Construction' ? 'selected' : '' }}>Construction</option>
                                        ...
                                        <option value="Agriculture" {{ old('industry', $job->industry ?? '') == 'Agriculture' ? 'selected' : '' }}>Agriculture</option>
                                        <option value="Transport & Logistics" {{ old('industry', $job->industry ?? '') == 'Transport & Logistics' ? 'selected' : '' }}>Transport & Logistics</option>
                                        <option value="Hospitality" {{ old('industry', $job->industry ?? '') == 'Hospitality' ? 'selected' : '' }}>Hospitality</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select id="experience_level" name="experience_level"
                                        ...
                                        <option value="no-experience" {{ old('experience_level', $job->experience_level ?? '') == 'no-experience' ? 'selected' : '' }}>No Experience</option>
                                ...
                                <div>
                                    ...
                                    <select id="education_level" name="education_level"
                                        ...
                                        <option value="no-education" {{ old('education_level', $job->education_level ?? '') == 'no-education' ? 'selected' : '' }}>No Education</option>
                                        ...
                                        <option value="degree" {{ old('education_level', $job->education_level ?? '') == 'degree' ? 'selected' : '' }}>Degree</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select id="visa_sponsorship" name="visa_sponsorship"
                                        class="appearance-none relative block w-full px-3 py-2 border border-gray-300 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm">
                                        <option value="0" {{ old('visa_sponsorship', $job->visa_sponsorship ?? 0) == '0' ? 'selected' : '' }}>No</option>
                                        <option value="1" {{ old('visa_sponsorship', $job->visa_sponsorship ?? 0) == '1' ? 'selected' : '' }}>Yes</option>
                                    </select>
                                </div>
                                <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="number" id="salary_min" name="salary_min"
                                        value="{{ old('salary_min', $job->salary_min) }}" step="0.01"
                                        class="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                                        placeholder="0.00">
                                </div>
                                <div>
                                    ...
                                    <input type="number" id="salary_max" name="salary_max"
                                        value="{{ old('salary_max', $job->salary_max) }}" step="0.01"
                                        class="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                                        placeholder="0.00">
                                </div>
                                <div>
