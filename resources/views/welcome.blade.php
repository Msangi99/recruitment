...
<head>
    ...
    <title>{{ config('app.name') }} - Talent meets opportunity</title>
    ...
    <div class="relative overflow-hidden">
        ...
        <header class="relative z-10">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
                ...
                <div class="hidden md:flex flex-1 justify-center items-center gap-6 text-sm font-bold text-blue-600">
                    ...
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}"
                                class="hidden rounded-xl border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-700 hover:border-blue-200 hover:text-blue-700 md:inline-flex">Go
                                to dashboard</a>
                        @else
                            <a href="{{ route('login') }}"
        ...
        <main class="relative z-10">
            ...
            <section class="mx-auto max-w-7xl px-6 pb-16 pt-6 lg:flex lg:items-center lg:gap-12">
                <div class="flex-1 space-y-6">
                    <span
                        class="inline-flex items-center gap-2 rounded-full bg-white/60 px-4 py-2 text-xs font-semibold uppercase tracking-[2px] text-blue-700 ring-1 ring-blue-100 shadow-sm">
                    ...
                    <p class="max-w-2xl text-lg text-slate-600">
                        Coyzon streamlines recruiting with verified candidates, structured profiles, and guided
                        workflows for both job seekers and hiring teams.
                    </p>
                    <div class="flex flex-wrap items-center gap-3">
                        <a href="{{ route('register') }}"
                            class="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-xl shadow-blue-500/30 hover:bg-blue-700">
                            Create free account
                            <i data-lucide="arrow-right" class="h-4 w-4"></i>
                        </a>
                        <a href="{{ route('login') }}"
                            class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 hover:border-blue-200 hover:text-blue-700 shadow-sm">
                            Sign in
                        </a>
                    </div>
                ...
                <div class="relative mt-10 flex-1 lg:mt-0">
                    ...
                    <div class="relative h-96 rounded-3xl overflow-hidden shadow-2xl">
                        <div id="hero-carousel" class="relative h-full">
                            <div
                                class="hero-slide active absolute inset-0 transition-opacity duration-1000 ease-in-out opacity-100">
                                <img src="{{ asset('user1.jpg') }}" alt="Recruitment"
                            ...
                            <div
                                class="hero-slide absolute inset-0 transition-opacity duration-1000 ease-in-out opacity-0">
                        ...
                        <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex gap-2">
                            <button
                                class="carousel-indicator active w-2 h-2 rounded-full bg-white transition-all duration-300"
                                data-slide="0"></button>
                            <button
                                class="carousel-indicator w-2 h-2 rounded-full bg-white/50 transition-all duration-300"
                                data-slide="1"></button>
                            <button
                                class="carousel-indicator w-2 h-2 rounded-full bg-white/50 transition-all duration-300"
                                data-slide="2"></button>
                    ...
                    <!-- Stats Card Overlay -->
                    <div
                        class="absolute -bottom-6 left-6 right-6 rounded-3xl border border-white/80 bg-white/90 p-6 shadow-2xl backdrop-blur">
                        <div class="grid grid-cols-2 gap-4">
                            <div
                                class="rounded-2xl border border-slate-100 bg-gradient-to-br from-blue-50 to-white p-4 shadow-sm">
                                <p class="text-xs uppercase tracking-[2px] text-slate-500 font-semibold mb-2">Employers
                                </p>
                                <p class="text-2xl font-bold text-slate-900">2.1K+</p>
                                <p class="text-sm text-slate-500">active companies</p>
                            </div>
                            <div
                                class="rounded-2xl border border-slate-100 bg-gradient-to-br from-indigo-50 to-white p-4 shadow-sm">
                            ...
                            <div
                                class="col-span-2 rounded-2xl border border-slate-100 bg-gradient-to-r from-blue-600 to-indigo-600 p-5 text-white shadow-lg">
                ...
                <section id="industries" class="mx-auto max-w-7xl px-6 pb-14">
                    ...
                    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                        @foreach($categories->take(8) as $category)
                            <div
                                class="group rounded-2xl border border-slate-100 bg-white p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                                <div
                                    class="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 text-blue-600 mb-4 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                                    @if($category->icon)
                                ...
                                @if($category->description)
                                    <p class="text-sm text-slate-600">
                                        {{ \Illuminate\Support\Str::limit($category->description, 80) }}</p>
                                @endif
                            </div>
                        @endforeach
                    </div>
            ...
            <section class="mx-auto max-w-7xl px-6 pb-14">
                <div class="text-center mb-10">
                    ...
                    <h2 class="mt-2 text-2xl font-bold text-slate-900">A circular journey from talent to opportunity
                    </h2>
                </div>
                <div class="relative flex items-center justify-center py-12">
                    ...
                    <div class="relative w-96 h-96">
                        ...
                        <svg class="w-full h-full transform -rotate-90" viewBox="0 0 400 400">
                            ...
                            <circle cx="200" cy="200" r="180" fill="none" stroke="#3b82f6" stroke-width="3"
                                stroke-dasharray="1130" stroke-dashoffset="0" class="process-circle" />
                        </svg>
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="grid grid-cols-2 gap-8 w-full h-full p-12">
                                <!-- Step 1: Register -->
                                <div class="process-step flex flex-col items-center justify-start text-center"
                                    data-step="1">
                                    <div
                                        class="w-16 h-16 rounded-full bg-blue-600 text-white flex items-center justify-center mb-3 shadow-lg">
                                ...
                                <div class="process-step flex flex-col items-center justify-start text-center"
                                    data-step="2">
                                    <div
                                        class="w-16 h-16 rounded-full bg-emerald-600 text-white flex items-center justify-center mb-3 shadow-lg">
                                ...
                                <!-- Step 3: Match -->
                                <div class="process-step flex flex-col items-center justify-end text-center"
                                    data-step="3">
                                    <div
                                        class="w-16 h-16 rounded-full bg-indigo-600 text-white flex items-center justify-center mb-3 shadow-lg">
                                ...
                                <div class="process-step flex flex-col items-center justify-end text-center"
                                    data-step="4">
                                    <div
                                        class="w-16 h-16 rounded-full bg-amber-600 text-white flex items-center justify-center mb-3 shadow-lg">
            ...
            <section class="mx-auto max-w-7xl px-6 pb-14">
                ...
                <div class="relative rounded-3xl border border-slate-100 bg-white p-8 shadow-lg overflow-hidden">
                    <div id="world-map"
                        class="relative h-96 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl flex items-center justify-center">
                        <!-- Simplified World Map SVG -->
                        <svg viewBox="0 0 1000 500" class="w-full h-full">
                            <!-- Continents simplified -->
                            <g class="continent" data-region="africa">
                                <path
                                    d="M450 200 L480 180 L500 200 L510 250 L500 300 L480 320 L450 310 L440 280 L440 240 Z"
                                    fill="#3b82f6" opacity="0.3"
                                    class="hover:opacity-60 cursor-pointer transition-opacity" />
                                <circle cx="470" cy="250" r="8" fill="#3b82f6" class="pulse-dot" />
                            </g>
                            <g class="continent" data-region="europe">
                                <path d="M480 100 L520 90 L540 120 L530 150 L510 160 L490 140 L480 120 Z" fill="#6366f1"
                                    opacity="0.3" class="hover:opacity-60 cursor-pointer transition-opacity" />
            ...
            <section id="how-it-works" class="mx-auto max-w-7xl px-6 pb-14">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h2 class="mt-2 text-2xl font-bold text-slate-900">A guided path for both candidates and
                            employers.</h2>
                    </div>
                </div>
                ...
                <div class="mt-8 grid gap-6 lg:grid-cols-3">
                    <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 text-blue-600 mb-4">
                            <i data-lucide="file-check" class="h-5 w-5"></i>
                        </div>
                        <h3 class="text-lg font-semibold text-slate-900">Structured profiles</h3>
                        <p class="mt-2 text-sm text-slate-600">Candidates showcase skills, documents, and verifications
                            in one place. Employers see clean, comparable profiles.</p>
                    </div>
                    <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 mb-4">
                            <i data-lucide="sparkles" class="h-5 w-5"></i>
                        </div>
                        <h3 class="text-lg font-semibold text-slate-900">Smart matching</h3>
                        <p class="mt-2 text-sm text-slate-600">Use filters, categories, and status tags to shortlist
                            faster. Built-in notes keep hiring teams aligned.</p>
                    </div>
                    <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600 mb-4">
                            <i data-lucide="calendar-clock" class="h-5 w-5"></i>
                        </div>
                        <h3 class="text-lg font-semibold text-slate-900">Appointments & follow-ups</h3>
                        <p class="mt-2 text-sm text-slate-600">Schedule interviews or consultations, track application
                            status, and keep candidates informed automatically.</p>
                    </div>
                </div>
            </section>
            ...
            <section id="solutions" class="mx-auto max-w-7xl px-6 pb-14">
                <div class="grid gap-8 lg:grid-cols-2">
                    <div class="rounded-3xl border border-slate-100 bg-white p-8 shadow-sm">
                        <div
                            class="flex items-center gap-2 text-xs uppercase tracking-[2px] font-semibold text-blue-700">
                        ...
                        <ul class="mt-4 space-y-3 text-sm text-slate-600">
                            <li class="flex items-start gap-2"><i data-lucide="shield-check"
                                    class="mt-0.5 h-4 w-4 text-emerald-500"></i> Verified profile and document uploads
                                keep you trusted with employers.</li>
                            <li class="flex items-start gap-2"><i data-lucide="layout-dashboard"
                                    class="mt-0.5 h-4 w-4 text-blue-500"></i> Dashboard view of applications, status,
                                and upcoming appointments.</li>
                            <li class="flex items-start gap-2"><i data-lucide="messages-square"
                                    class="mt-0.5 h-4 w-4 text-indigo-500"></i> Guided consultations to get
                                interview-ready.</li>
                        </ul>
                        <div class="mt-6 flex flex-wrap gap-3">
                            <a href="{{ route('register') }}"
                                class="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/30 hover:bg-blue-700">Create
                                candidate profile</a>
                            <a href="{{ route('login') }}"
                                class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 hover:border-blue-200 hover:text-blue-700">Sign
                                in</a>
                        </div>
                    </div>
                    ...
                    <div class="rounded-3xl border border-slate-100 bg-white p-8 shadow-sm">
                        <div
                            class="flex items-center gap-2 text-xs uppercase tracking-[2px] font-semibold text-amber-700">
                        ...
                        <ul class="mt-4 space-y-3 text-sm text-slate-600">
                            <li class="flex items-start gap-2"><i data-lucide="filter"
                                    class="mt-0.5 h-4 w-4 text-blue-500"></i> Filter by categories, status, and
                                readiness to interview.</li>
                            <li class="flex items-start gap-2"><i data-lucide="files"
                                    class="mt-0.5 h-4 w-4 text-indigo-500"></i> View candidate documents, profiles, and
                                verification badges in one view.</li>
                            <li class="flex items-start gap-2"><i data-lucide="calendar"
                                    class="mt-0.5 h-4 w-4 text-emerald-500"></i> Request interviews and manage
                                appointments inside the platform.</li>
                        </ul>
                        <div class="mt-6 flex flex-wrap gap-3">
                            <a href="{{ route('register') }}"
                                class="inline-flex items-center gap-2 rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-slate-900/20 hover:bg-slate-800">Create
                                employer account</a>
                            <a href="{{ route('login') }}"
                                class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 hover:border-blue-200 hover:text-blue-700">Sign
                                in</a>
            ...
            <section id="testimonials" class="mx-auto max-w-7xl px-6 pb-16">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h2 class="mt-2 text-2xl font-bold text-slate-900">Trusted by growing companies and ambitious
                            talent.</h2>
                    </div>
                </div>
                ...
                <div class="mt-8 grid gap-6 lg:grid-cols-3">
                    <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                        <div class="flex items-center gap-3">
                            <div
                                class="h-10 w-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-700 font-bold">
                                AM</div>
                            <div>
                        ...
                        <p class="mt-4 text-sm text-slate-600">“Shortlists that used to take two weeks now take two
                            days. Verification badges give our team confidence to move forward faster.”</p>
                    </div>
                    <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                        <div class="flex items-center gap-3">
                            <div
                                class="h-10 w-10 rounded-full bg-emerald-50 flex items-center justify-center text-emerald-700 font-bold">
                                DK</div>
                            <div>
                        ...
                        <p class="mt-4 text-sm text-slate-600">“I loved seeing my profile score improve with each
                            document and step. Interviews were scheduled without endless email back-and-forth.”</p>
                    </div>
                    <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                        <div class="flex items-center gap-3">
                            <div
                                class="h-10 w-10 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-700 font-bold">
                                SO</div>
                            <div>
                        ...
                        <p class="mt-4 text-sm text-slate-600">“Centralizing documents and appointments removed a ton of
                            manual follow-up. Candidates feel guided; we feel in control.”</p>
                    </div>
                </div>
            </section>
            ...
            <section id="faq" class="mx-auto max-w-4xl px-6 pb-14">
                <div class="text-center mb-10">
                    <p class="text-xs uppercase tracking-[2px] text-blue-700 font-semibold">Frequently Asked Questions
                    </p>
                ...
                <div class="space-y-4">
                    <div class="faq-item rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden">
                        <button
                            class="faq-button w-full px-6 py-4 text-left flex items-center justify-between hover:bg-slate-50 transition-colors"
                            data-faq="1">
                            <span class="font-semibold text-slate-900">How does the verification process work?</span>
                            <i data-lucide="chevron-down"
                                class="h-5 w-5 text-slate-400 faq-icon transition-transform"></i>
                        </button>
                        <div class="faq-content hidden px-6 pb-4">
                            <p class="text-sm text-slate-600">Candidates submit their profiles with required documents.
                                Our admin team reviews and verifies all information, including ID, passport, CV, and
                                professional credentials. Once approved, profiles become visible to employers.</p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden">
                        ...
                        <div class="faq-content hidden px-6 pb-4">
                            <p class="text-sm text-slate-600">We accept M-Pesa, Tigo Pesa, Airtel Money, Halopesa, and
                                credit/debit cards through our secure payment gateway. All payments are processed
                                securely and are required before booking consultations.</p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden">
                        ...
                        <div class="faq-content hidden px-6 pb-4">
                            <p class="text-sm text-slate-600">No, your contact information is kept private. Employers
                                can only see your verified profile, skills, and professional information. Contact
                                details are only shared after you accept an interview request.</p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden">
                        ...
                        <div class="faq-content hidden px-6 pb-4">
                            <p class="text-sm text-slate-600">Typically, profile verification is completed within 24-48
                                hours after submission. You'll receive email notifications at each stage of the process.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden">
                        ...
                        <div class="faq-content hidden px-6 pb-4">
                            <p class="text-sm text-slate-600">Job posting is free for employers. However, consultations
                                with candidates require payment. Employers can browse verified candidates and request
                                interviews at no cost.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="mx-auto max-w-6xl px-6 pb-20">
                <div
                    class="overflow-hidden rounded-3xl bg-gradient-to-r from-slate-900 via-indigo-900 to-blue-700 px-8 py-10 shadow-2xl">
                    <div class="grid gap-6 lg:grid-cols-2 lg:items-center">
                        <div class="space-y-4">
                            <p class="text-xs uppercase tracking-[2px] text-blue-100 font-semibold">Ready to begin?</p>
                            <h3 class="text-3xl font-bold text-white">Build your profile or publish your next role in
                                minutes.</h3>
                            <p class="text-sm text-blue-100 max-w-xl">Join the Coyzon community and move from search to
                                shortlist faster. No setup fees. Guided onboarding.</p>
                            <div class="flex flex-wrap gap-3">
                                <a href="{{ route('register') }}"
                                    class="inline-flex items-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-semibold text-slate-900 shadow-lg hover:bg-slate-100">
                                    Start for free
                                    <i data-lucide="arrow-right" class="h-4 w-4"></i>
                                </a>
                                <a href="{{ route('login') }}"
                                    class="inline-flex items-center gap-2 rounded-xl border border-white/30 px-4 py-2.5 text-sm font-semibold text-white hover:bg-white/10">Sign
                                    in</a>
                            </div>
                        </div>
                        <div class="hidden justify-end lg:flex">
                            <div class="rounded-2xl bg-white/10 p-6 ring-1 ring-white/20 backdrop-blur">
                                ...
                                <div class="mt-4 text-sm text-blue-100">
                                    Transparent workflows, built-in verifications, and clear communication keep every
                                    stakeholder aligned.
                                </div>
                            </div>
                        </div>
