...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white rounded-lg shadow-md p-8 prose prose-lg max-w-none">
            ...
            <p>COYZON ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our recruitment platform.</p>
            ...
            <p>Payment processing is handled by third-party payment gateways (Selcom, AzamPay). We do not store complete credit card information on our servers.</p>
            ...
            <p>Verified candidate profiles are visible to employers. However, contact details are hidden until an interview request is made and accepted.</p>
            ...
            <p>Candidates can control profile visibility through the <code>is_public</code> setting. Only verified and public profiles are visible to employers.</p>

            <h2>8. Data Retention</h2>
            <p>We retain your information for as long as your account is active or as needed to provide services. After account deletion, data may be retained for legal or backup purposes for up to 90 days.</p>
            ...
            <p>Our platform is not intended for individuals under 18 years of age. We do not knowingly collect information from minors.</p>

            <h2>11. International Data Transfers</h2>
            <p>Your information may be transferred to and processed in countries other than Tanzania. We ensure appropriate safeguards are in place for such transfers.</p>
            ...
            <div class="bg-gray-100 border-l-4 border-indigo-600 p-4 mt-8">
                <p class="text-sm text-gray-700">
                    ...
                    COYZON is committed to transparency and maintaining the highest standards of data protection and privacy compliance.
                </p>
            </div>
        </div>
    </div>
