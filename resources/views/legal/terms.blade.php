...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white rounded-lg shadow-md p-8 prose prose-lg max-w-none">
            ...
            <p>Welcome to COYZON. By accessing and using our recruitment platform, you agree to comply with and be bound by the following terms and conditions.</p>

            <h2>2. Acceptance of Terms</h2>
            <p>By registering for an account or using our services, you acknowledge that you have read, understood, and agree to be bound by these Terms & Conditions and our Privacy Policy.</p>

            <h2>3. User Accounts</h2>
            <h3>3.1 Registration</h3>
            <p>Users must provide accurate, current, and complete information during the registration process. You are responsible for maintaining the confidentiality of your account credentials.</p>
            ...
            <p>Candidate consultation services are charged at TZS 30,000 or $12 per session. Payment must be completed before the consultation is confirmed.</p>

            <h3>5.2 Payment Methods</h3>
            <p>We accept payments through Selcom and AzamPay gateways, including mobile money, card payments, and bank transfers.</p>

            <h3>5.3 Refund Policy</h3>
            <p>Refunds may be granted in case of service cancellation by the platform. Requests must be made within 24 hours of payment.</p>
            ...
            <p>We are committed to protecting your privacy. Please review our <a href="{{ route('privacy') }}" class="text-indigo-600 hover:text-indigo-700">Privacy Policy</a> to understand how we collect, use, and protect your personal information.</p>

            <h2>8. Intellectual Property</h2>
            <p>All content on the COYZON platform, including text, graphics, logos, and software, is the property of COYZON and protected by copyright laws.</p>

            <h2>9. Limitation of Liability</h2>
            <p>COYZON shall not be liable for any indirect, incidental, special, or consequential damages arising out of or in connection with the use of our services.</p>
            ...
            <div class="bg-gray-100 border-l-4 border-indigo-600 p-4 mt-8">
                <p class="text-sm text-gray-700">
                    ...
                    NOTE: This is a public professional trade site. We maintain the highest standards of professionalism and compliance in all career & development services.
                </p>
            </div>
        </div>
    </div>
