                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="languages" name="languages"
                                    ...
                                    <option value="English" {{ old('languages') == 'English' ? 'selected' : '' }}>English
                                    </option>
                                    <option value="Arabic" {{ old('languages') == 'Arabic' ? 'selected' : '' }}>Arabic
                                    </option>
                                    <option value="French" {{ old('languages') == 'French' ? 'selected' : '' }}>French
                                    </option>
                                    <option value="Swahili" {{ old('languages') == 'Swahili' ? 'selected' : '' }}>Swahili
                                    </option>
                                </select>
                            </div>
                        </div>
