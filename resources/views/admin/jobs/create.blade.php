    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="bg-white shadow-sm border border-gray-200 rounded-xl overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                <h2 class="text-xl font-bold text-gray-900">Post New Job Listing</h2>
                <p class="text-sm text-gray-500">Fill in the details below to reach thousands of candidates</p>
            </div>

            <form method="POST" action="{{ route('admin.jobs.store') }}" class="p-6 md:p-8">
                @csrf
                <div class="space-y-8">
                    <!-- Basic Info -->
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" id="experience_required" name="experience_required"
                                    value="{{ old('experience_required', 0) }}" min="0"
                            ...
                            <div>
                                ...
                                <select id="work_hours" name="work_hours"
                                    ...
                                    <option value="full-time" {{ old('work_hours') == 'full-time' ? 'selected' : '' }}>Full
                                        time</option>
                                    <option value="part-time" {{ old('work_hours') == 'part-time' ? 'selected' : '' }}>Part
                                        time</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="education_level" name="education_level"
                                    ...
                                    <option value="secondary-school" {{ old('education_level') == 'secondary-school' ? 'selected' : '' }}>Secondary School</option>
                                    ...
                                    <option value="master-plus" {{ old('education_level') == 'master-plus' ? 'selected' : '' }}>Master's Degree+</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="languages" name="languages"
                                    ...
                                    <option value="no-requirement" {{ old('languages') == 'no-requirement' ? 'selected' : '' }}>No language requirement</option>
                                    <option value="Basic English" {{ old('languages') == 'Basic English' ? 'selected' : '' }}>
                                        Basic English</option>
                                    <option value="Intermediate English" {{ old('languages') == 'Intermediate English' ? 'selected' : '' }}>Intermediate English</option>
                                    <option value="Advanced English" {{ old('languages') == 'Advanced English' ? 'selected' : '' }}>Advanced English</option>
                                    <option value="Other language required" {{ old('languages') == 'Other language required' ? 'selected' : '' }}>Other language required</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="md:col-span-1">
                                ...
                                <select id="country" name="country" required
                                    ...
                                    <option value="Romania" {{ old('country') == 'Romania' ? 'selected' : '' }}>Romania
                                    </option>
                                    <option value="Croatia" {{ old('country') == 'Croatia' ? 'selected' : '' }}>Croatia
                                    </option>
                                    <option value="OMAN" {{ old('country') == 'OMAN' ? 'selected' : '' }}>OMAN</option>
                                    <option value="Australia" {{ old('country') == 'Australia' ? 'selected' : '' }}>Australia
                                    </option>
                                    <option value="QUATAR" {{ old('country') == 'QUATAR' ? 'selected' : '' }}>QUATAR</option>
                                    ...
                                    <option value="Ukraine" {{ old('country') == 'Ukraine' ? 'selected' : '' }}>Ukraine
                                    </option>
                                    ...
                                    <option value="Other Countries" {{ old('country') == 'Other Countries' ? 'selected' : '' }}>Other Countries</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <textarea id="description" name="description" rows="8" required
                                    ...
                                    placeholder="Explain the role, day-to-day tasks, and what the candidate will be doing...">{{ old('description') }}</textarea>
                            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <select id="salary_currency" name="salary_currency"
                                    class="w-full border border-gray-300 rounded-xl px-4 py-2.5 focus:ring-blue-500 focus:border-blue-500 shadow-sm bg-white">
                                    <option value="TZS" {{ old('salary_currency') == 'TZS' ? 'selected' : '' }}>TZS</option>
                            ...
                            <div>
                                ...
                                <select id="salary_period" name="salary_period"
                                    ...
                                    <option value="hourly" {{ old('salary_period') == 'hourly' ? 'selected' : '' }}>Hourly
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-gray-50 rounded-xl border border-gray-100 mt-6">
                            ...
                            <div class="ml-3 text-sm font-medium">
                                <label for="is_active" class="font-bold text-gray-700">Publish Immediately</label>
                                <p class="text-gray-500">Job will be visible to all candidates on the platform.</p>
                            </div>
                        </div>
                    </div>
