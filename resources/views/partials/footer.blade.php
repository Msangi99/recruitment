    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('about') }}" class="text-gray-400 hover:text-white transition-colors">About
                            Us</a></li>
                    <li><a href="{{ route('public.jobs.index') }}"
            ...
            <div>
                ...
                <ul class="space-y-2">
                    @guest
                        ...
                        <li><a href="{{ route('public.jobs.index') }}"
                                class="text-gray-400 hover:text-white transition-colors">Browse Jobs</a></li>
                    @else
                        @if(auth()->user()->role === 'candidate')
                            <li><a href="{{ route('candidate.dashboard') }}"
                                    class="text-gray-400 hover:text-white transition-colors">Dashboard</a></li>
                            <li><a href="{{ route('candidate.profile.show') }}"
                                    class="text-gray-400 hover:text-white transition-colors">My Profile</a></li>
                            <li><a href="{{ route('candidate.jobs.index') }}"
                                    class="text-gray-400 hover:text-white transition-colors">Browse Jobs</a></li>
                            <li><a href="{{ route('candidate.consultations.create') }}"
                                    class="text-gray-400 hover:text-white transition-colors">Book Consultation</a></li>
                        @endif
                    @endguest
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('public.candidates.index') }}"
                            class="text-gray-400 hover:text-white transition-colors">Browse Candidates</a></li>
                    <li><a href="{{ route('contact') }}"
                            class="text-gray-400 hover:text-white transition-colors">Contact Us</a></li>
                </ul>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ url('/terms') }}" class="text-gray-400 hover:text-white transition-colors">Terms &
                            Conditions</a></li>
                    <li><a href="{{ url('/privacy') }}" class="text-gray-400 hover:text-white transition-colors">Privacy
                            Policy</a></li>
                </ul>
            </div>
        </div>
