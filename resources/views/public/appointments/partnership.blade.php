        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                <a href="{{ route('public.appointments.index') }}"
                    class="text-indigo-600 hover:text-indigo-800 font-bold flex items-center">
            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                <div class="bg-indigo-600 px-8 py-6">
                    ...
                    <p class="text-indigo-100 mt-2">Explore recruitment partnership opportunities with us.</p>
                </div>
                ...
                <form action="{{ route('public.appointments.storePartnership') }}" method="POST" class="p-8 space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Website / LinkedIn</label>
                    ...
                    <div>
                        ...
                        <select name="partnership_type" required
                            ...
                            <option value="sourcing_partner">Candidate Sourcing Partner</option>
                            <option value="employer_referral">Employer Referral Partner</option>
                    ...
                    <div>
                        ...
                        <textarea name="message" rows="4"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm p-3 border"></textarea>
                    </div>

                    <div class="pt-4">
                        <button type="submit"
                            class="w-full flex justify-center py-4 px-4 border border-transparent rounded-xl shadow-sm text-lg font-bold text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all">
