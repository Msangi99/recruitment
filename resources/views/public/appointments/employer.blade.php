...
@section('content')
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                <div class="bg-green-600 px-8 py-6">
                    ...
                    <p class="text-green-100 mt-2">Schedule a free session to discuss your workforce requirements.</p>
                </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-xs font-bold text-gray-500 uppercase tracking-wider">Available Slots</span>
                                </div>
                            </div>
                            ...
                            <div id="selectionPreview" class="hidden bg-green-50 border border-green-100 p-4 rounded-xl flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-xs font-bold text-green-700 uppercase tracking-wider">Your Selection</p>
                                        <p id="selectedDateTimeText" class="text-sm font-bold text-green-900"></p>
                                    </div>
                                </div>
                                <button type="button" onclick="clearSelection()" class="text-xs font-bold text-green-700 hover:text-green-900">
                                    Change
                                </button>
                            </div>
    ...
    <style>
        ...
        .fc-toolbar-title { font-size: 1.125rem !important; font-weight: 800 !important; color: #1e293b !important; }
        .fc-button { background: #ffffff !important; border: 1px solid #e2e8f0 !important; color: #475569 !important; font-weight: 700 !important; font-size: 0.875rem !important; border-radius: 8px !important; }
        .fc-button-active { background: #16a34a !important; color: white !important; border-color: #16a34a !important; }
        .fc-daygrid-day-number { font-weight: 600 !important; color: #475569 !important; padding: 10px !important; text-decoration: none !important; }
        .fc-col-header-cell-cushion { font-weight: 700 !important; color: #94a3b8 !important; text-transform: uppercase !important; font-size: 0.75rem !important; padding: 10px 0 !important; text-decoration: none !important; }
        .selected-date { background-color: #16a34a !important; color: white !important; border-radius: 8px; }
