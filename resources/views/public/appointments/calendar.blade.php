                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                @if(session('error_details'))
                                    <details class="mt-3">
                                        <summary class="text-xs font-bold text-red-600 cursor-pointer hover:text-red-800">Show technical details</summary>
                                        <div class="mt-2 p-3 bg-red-100/50 rounded-lg border border-red-200">
                                            <p class="text-xs text-red-700 font-mono break-all">{{ session('error_details') }}</p>
                                        </div>
                                    </details>
                                @endif
                                <div class="mt-4">
...
<style>
    .fc { --fc-border-color: #f1f5f9; --fc-today-bg-color: #f0f9ff; font-family: inherit; }
    .fc-toolbar-title { font-size: 1.125rem !important; font-weight: 800 !important; color: #1e293b !important; text-transform: uppercase; letter-spacing: -0.025em; }
    .fc-button { background: #ffffff !important; border: 1px solid #e2e8f0 !important; color: #475569 !important; font-weight: 700 !important; font-size: 0.875rem !important; border-radius: 12px !important; padding: 8px 16px !important; transition: all 0.2s !important; }
    .fc-button:hover { background: #f8fafc !important; border-color: #cbd5e1 !important; }
    .fc-button-active { background: #2563eb !important; color: white !important; border-color: #2563eb !important; }
    .fc-daygrid-day-number { font-weight: 700 !important; color: #64748b !important; padding: 12px !important; text-decoration: none !important; font-size: 0.875rem; }
    .fc-col-header-cell-cushion { font-weight: 800 !important; color: #94a3b8 !important; text-transform: uppercase !important; font-size: 0.7rem !important; padding: 12px 0 !important; text-decoration: none !important; letter-spacing: 0.05em; }
    .selected-date { background-color: #2563eb !important; color: white !important; border-radius: 12px; }
    .fc-timegrid-slot { height: 3.5rem !important; border-bottom: 1px dashed #f1f5f9 !important; }
    .fc-list-event-title { font-weight: 600 !important; }
</style>
<script>
