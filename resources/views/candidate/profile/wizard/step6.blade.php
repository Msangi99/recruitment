...
@section('wizard-content')
    <div class="max-w-3xl mx-auto">
        <div class="text-center mb-8">
            <h2 class="text-2xl font-bold text-slate-900">Education & Certifications</h2>
        ...
        <!-- Certifications Section (Optional Text) -->
        <!-- Assuming we just want to show this field but maybe not saving it yet as per schema limitations, or just leave it for now -->
