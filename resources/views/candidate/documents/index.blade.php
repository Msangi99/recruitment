            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="px-4 py-6 sm:px-0">
                    ...
                    <div class="bg-white shadow-lg rounded-lg p-8 mb-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-6 pb-2 border-b border-gray-200">Upload New Document
                        </h3>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select id="document_type" name="document_type" required
                                        ...
                                        <option value="video_cv">Video CV</option>
                                ...
                                <div>
                                    <label for="document" class="block text-sm font-medium text-gray-700 mb-2">File
                                        *</label>
                                    ...
                                    @error('document')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-2 text-xs text-gray-500">PDF, DOC, DOCX, JPG, PNG, MP4, MOV, AVI (Max 20MB)
                                    </p>
                                </div>
                            </div>
                                                        ...
                                                        <tr class="hover:bg-gray-50">
                                                            <td class="px-6 py-4 whitespace-nowrap">
                                                                <div class="text-sm font-medium text-gray-900">
                                                                    {{ $document->document_type == 'video_cv' ? 'Video CV' : ucfirst($document->document_type) }}
                                                                </div>
                                                            </td>
                                                            <td class="px-6 py-4">
                                    ...
                                    ($document->verification_status == 'pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800') }}">
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                                <div class="flex items-center justify-end gap-3">
                                                                    ...
                                                                    <form method="POST"
                                                                        action="{{ route('candidate.documents.destroy', $document) }}"
                                                                        class="inline"
